...
namespace Lab_02
{
    public partial class Form1 : Form
    {
        ...
        // Decorator: добавить новые свойства к созданным постройкам
        private void button8_Click(object sender, EventArgs e) => MainDecorator.DecoratorMain();




        //Building decorator = new MainDecorator(); // decorator
        //string res = decorator.ToString();    
        //MessageBox.Show("______________________________________\n\n" + res);huiu[]]



        // Memento:  позволяет сохранять и восстанавливать прошлые состояния объектов, не раскрывая подробностей их реализации
        private void Memento_Click(object sender, EventArgs e)
        {
            _mementoForm.Show();
        }
    }
